        ...
        <>
            ...
            <div className="py-5 home-background" >
                ...
                <div className='py-5 intro'>
                    <h1 className='py-5'>Welcome to <span className="blue">DailyDish.</span></h1>
                    <h4 className='py-3'>Your ultimate destination for delicious and convenient meal solutions!</h4>
                    ...
                    <Button> Get started in three easy steps</Button>
                </div>
